<template>
  <section class="section pb-5" style="overflow: hidden">
    <div
    ...
    >
      <p class="text-center" style="color: #f59e0b">
        See O<span style="border-top: 2px solid #f59e0b; padding-top: 8px"
          >ur Se</span
        >rvices
      </p>
    ...
    <div class="row gap-5">
      ...
      >
        <swiper-slide v-for="service in services" :key="service.title">
          <div style="height: 355px !important" class="cardimage col-4 mb-5">
            <div class="card-body">
              <div style="margin: 40px">
                <h4>{{ service.title }}</h4>
                <p style="font-weight: lighter">{{ service.description }}</p>
                <button
...
export default {
  ...
  data() {
    return {
      services: [
        { title: "Service1", description: "service brief" },
        { title: "Service1", description: "service brief" },
        { title: "Service1", description: "service brief" },
      ],
    };
